...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://192.168.0.4:8000', # For local network access if server runs on this IP/port
...
ALLOWED_HOSTS = [
    ...
    '192.168.0.4', # IP da sua máquina na rede local (verifique e ajuste se for diferente)
]