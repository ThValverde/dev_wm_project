# Generated by Django 5.2.3 on 2025-06-21 17:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concentracao_unidade', models.CharField(blank=True, choices=[('mcg/g', 'mcg/g'), ('mg/g', 'mg/g'), ('mg/ml', 'mg/ml'), ('OUT', 'Outro')], max_length=5, null=True, verbose_name='Unidade de Concentração')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grupos', models.ManyToManyField(blank=True, related_name='perfil_membros', to='api.grupo', verbose_name='Grupos do Usuário')),
