# Generated by Django 5.2.3 on 2025-06-23 02:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Grupo',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='ID do Grupo')),
                ('nome', models.CharField(help_text='Nome da casa de idosos', max_length=100, verbose_name='Nome do Grupo')),
                ...
                ('endereco', models.CharField(blank=True, help_text='Endereço da casa de idosos', max_length=255, verbose_name='Endereço do Grupo')),
                ('telefone', models.CharField(blank=True, help_text='Telefone de contato da casa de idosos', max_length=20, verbose_name='Telefone do Grupo')),
                ('cidade', models.CharField(blank=True, help_text='Cidade onde a casa de idosos está localizada', max_length=100, verbose_name='Cidade do Grupo')),
                ('estado', models.CharField(blank=True, help_text='Estado onde a casa de idosos está localizada', max_length=100, verbose_name='Estado do Grupo')),
                ('cep', models.CharField(blank=True, help_text='CEP da casa de idosos', max_length=10, verbose_name='CEP do Grupo')),
                ('nome_responsavel', models.CharField(blank=True, help_text='Nome do responsável pela casa de idosos', max_length=100, verbose_name='Nome do Responsável')),
